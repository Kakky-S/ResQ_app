...
class _ChatBotState extends State<chatBot> {
    ...
    switch (key) {
      case 'answerWhiplash':
        ...
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => Symptom(paramText: key)));
        break;
  ...
  Future<void> getData(key) async {
    var snapshot = await FirebaseFirestore.instance.collection(
        'medical_consultation').doc(key).get();
                      ...
                      return
                        Padding(
                          ...
                          child: OutlinedButton(
                            ...
                            onPressed: () =>
                            {
                              setKey(dataList[index].content, dataList[index]
                                  .nextId, dataList[index].question),
